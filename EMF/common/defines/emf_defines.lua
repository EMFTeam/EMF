...
NDefines.NTitle.MAX_CROWN_LAW_CHANGES = 64                                 -- a power of 2 here is critical, so critical
NDefines.NTitle.DE_JURE_ASSIMILATION_YEARS = 80
...
NDefines.NAI.COALITION_DISTANCE_MULTIPLIER = -1.25       -- from -1.1 (-1.5 in 5.02)
