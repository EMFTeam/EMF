-- Diplomacy
NDefines.NDiplomacy.LONG_REIGN_YEARS_START = 12
NDefines.NDiplomacy.GAVELKIND_MAX_SIZE_BONUS = 0.5
NDefines.NDiplomacy.INTER_MUSLIM_WAR_MONTHLY_PIETY_COST = 0.5 -- from 1 from 2
NDefines.NDiplomacy.MUSLIM_TEMPLE_HOLDING_MONTHLY_PIETY = 0.4 -- from 0.2
...
NDefines.NCharacter.RAISED_TROOPS_VASSAL_OPINION_DAYS = 42 -- from 54 from 61
...
NDefines.NCharacter.NATURAL_DEATH_CHANCE_AGE_60 = 600 -- +50%
NDefines.NCharacter.NATURAL_DEATH_CHANCE_AGE_70 = 2100 -- +50%
...
NDefines.NTitle.EMPEROR_CREATION_COST = 1200
...
-- Economy
NDefines.NEconomy.MUSLIM_MUSLIM_PROVINCE_TAX_MOD = 0 -- was -0.1
NDefines.NEconomy.BISHOP_TAX_TO_POPE_FACTOR = 0.25 -- more than doubled
NDefines.NEconomy.DECADENCE_MODIFIER = 0.1 -- halved
NDefines.NEconomy.TRADE_POST_COST_INC_DIST = 0.0045
NDefines.NEconomy.PATRICIAN_CITY_TAX_MULT = 0.25 -- halved
...
-- Nomad
NDefines.NNomad.MAX_POPULATION_EMPTY_HOLDING_MULTIPLIER = 1500 -- from 1250
NDefines.NNomad.MAX_CLANS = 12 -- *
NDefines.NNomad.STARTING_HORDE_MAX_FRACTION = 1

-- Military
NDefines.NMilitary.MORALE_COLLAPSE_THRESHOLD = 0.3
NDefines.NMilitary.NUMBER_OF_RETREAT_DAYS = 2 -- *
NDefines.NMilitary.NUMBER_OF_TROOPS_PER_GALLEY = 200
NDefines.NMilitary.LEVY_MAINTENANCE_FACTOR = 2.0 -- up from 1.8
...
NDefines.NMilitary.ARMY_LOAD_MOVE_COST = 40.0NDefines.NMilitary.
NDefines.NMilitary.HIGH_DECADENCE_MORALE_MOD = 0 -- from -0.5
...
-- Disease
NDefines.NDisease.CROWDED_THRESHOLD_MODIFIER = 40 -- from 50

-- Engine
NDefines.NEngine.EVENT_PROCESS_OFFSET = 30

-- AI
NDefines.NAI.DOW_AGGRESSION_FACTOR = 0.6
NDefines.NAI.REVOLT_OTHER_INDEP_RISK = 20
NDefines.NAI.REVOLT_OTHER_INDEP_RISK_CAP = 80
