...
NCharacter = {
	...
	MAX_JOINED_FACTIONS = 5,						-- Maximum number of Factions a character can be a member of (including led factions)
...
NEconomy = {
	...
	BUILDING_COST_MULT = 0.0,						-- Increase to the build cost of all buildings that cost GOLD
