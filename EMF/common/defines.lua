...
NDiplomacy = {
	...
	CALL_TO_WAR_DELAY = 48, 					-- Months between attempts to call someone into war
	...
	PRESTIGE_OPINION_DIV = 300,					-- Divider for prestige to vassal opinion (5x higher effect for negative prestige)
...
NCharacter = {
	...
	LUNATIC_TRAIT_CHANCE_FACTOR = 0.4,				-- Inbreeding: Multiplier to the base chance
	INBRED_DIVINE_BLOOD_TRAIT_CHANCE_FACTOR = 1.5,	-- Inbreeding: Multiplier to the base chance
	LUNATIC_DIVINE_BLOOD_TRAIT_CHANCE_FACTOR = 0.4,	-- Inbreeding: Multiplier to the base chance
...
NReligion = {
	...
	ELECTOR_FAMOUS_DYNASTY_FACTOR = 0.1,
...
NMilitary = {
	...
	ARMY_LOAD_MOVE_COST = 30.0,						-- Movement cost for moving armies onto fleets at sea.
	ARMY_UNLOAD_MOVE_COST = 10.0,					-- Movement cost for moving armies off fleets at sea.
...
NAI =
{
	...
	MARRIAGE_AI_PRESTIGE_VALUE = 0.6,						-- Multiplier for how highly AI values prestige when arranging marriages and evaluating marriage offers
