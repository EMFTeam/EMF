...
NDiplomacy = {
	...
	ASK_FOR_EXCOMMUNICATION_INTERACTION_THRESHOLD_FOR_NO = 50,
	ASK_FOR_EXCOMMUNICATION_INTERACTION_THRESHOLD_FOR_YES = 120,
	...
	BANISH_TAKE_WEALTH_PERCENTAGE_COURTIER = 0.5,
...
NCharacter = {
	...
	CHANGE_FOCUS_YEARS = 4,							-- Delay between being able to change focus
	...
	ASSIGN_ACTION_DAYS = 21, 						-- Days before a Councillor can be assigned a new job in a county
...
NEconomy = {
	...
	MUSLIM_MUSLIM_PROVINCE_TAX_MOD = 0,				-- Muslims get less tax from muslim provinces
	...
	OVER_MAX_DEMESNE_TAX_PENALTY = 0.15,			-- Percent penalty per county over the limit
	TAX_TO_LOOT_MULTIPLIER = 1.0,					-- Lootable gold per tax 
	FORT_LOOT_DEFENCE_MULTIPLIER = 4.0,				-- Loot protected gold per fortlevel
	LOOTABLE_GOLD_REGROWTH = 0.0125,				-- Percent of max lootable gold that regrows every month
...
NMilitary = {
	...
	REVOLTRISK_REDUCTION_PER_YEAR = 2,
	...
	LIEGE_LEVY_COST_MULTIPLIER = 0.8,				-- The vassal will pay regular maintenance * this for the liege levy
...
NTechnology = {
	...
	NEIGHBOUR_SAME_RELIGON_GROUP_MULT = 1.5, 	-- multiplier to the above bonus if neighbour is of your religious group
	...
	TRADEPOST_SPREAD_BONUS = 0.004, 			-- Spread from trade posts
	SPYACTION_SPREAD_BONUS = 0.012,				-- Spread from the target of the study technology spymaster action
...
NAI =
{
	...
	RAID_AGGRESSION = 22,									-- General frequency of raids. A LOWER number means more often!
