...
NDiplomacy = {
	...
	TOG_REVOLT_CHANCE_MOD = 175,				-- Old Gods rebel spawn chance modifier (fires on_rebel_revolt) : lower means fewer revolts. MUST NOT BE ZERO. 
	...
	EXECUTE_IMPRISONED_INTERACTION_PIETY = 10,
	...
	ASK_FOR_CLAIM_INTERACTION_THRESHOLD_FOR_YES = 50,
...
NCharacter = {
	...
	CHANGE_AMBITION_YEARS = 1,						-- Delay between being able to pick a new ambition of plot after cancelling
	CHANGE_FOCUS_YEARS = 3,							-- Delay between being able to change focus
	...
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 54,			-- After 61 days of having their troops raised, vassals will get -1 opinion more of you
	...
	NOT_SPOUSE_FERTILITY_MULT = 0.125,				-- Applied to fertility when the two characters are not married
...
-- Title creation and usurpation requirements	
	...
	CUSTOM_TITLE_COLOR_OFFSET = 0.25					-- The offset from the base title color when creating a new title
},
...
NReligion = {
	...
	AUTHORITY_FROM_RELHEAD_DIPLOMACY = 0.025,		-- Authority from each 10 diplomacy of religious head
...
NEconomy = {
	HOLDING_SLOT_BUILD_COST_MOD = 0.25,
	REPUBLIC_CITY_TAX_BONUS = 0.2,					-- Republics (at least Count tier) receive a tax bonus for all cities in their realm
	...
	OVER_MAX_DEMESNE_TAX_PENALTY = 0.1,			-- Percent penalty per county over the limit
...
NMilitary = {
	...
	LEVY_MAINTENANCE_FACTOR = 1.8,					-- General maintenance factor for levy troops
	...
	BATTLE_MINIMUM_WARSCORE = 0.4,					-- Battles below this value(in actual percentage) are removed from warscore calculations
	...
	MIN_LEVIES_ABOVE_OPINION_THRESHOLD = 0.25,		-- The minimum percentage of levies that will be provided if opinion is above threshold
	...
	PERCENT_OF_GARRISON_DETACHED = 0.15,			-- This percent of the garrison is detached from the winning unit of a siege
	...
	CONTESTED_TITLE_OCCUPIED_WARSCORE_BONUS_INDEP = 25,	-- Amount of warscore per year since attacker/defender started getting the bonus, for independence and tyranny wars (can be overridden separately in religion scripts)
	...
	CAPTURED_HEIR_WAR_SCORE = 30.0,					-- War score for holding the heir prisoner
	...
	LOOTED_MODIFIER_MONTHS = 24,					-- How long pagan looting lasts
	...
	LOOT_HOLDING_DESTRUCTION_ODDS = 16,				-- a holding with less than LOOT_HOLDING_DEST_MIN_SAFE buildings will be destroyed by looting
	LOOT_HOLDING_BUILDING_DEST_ODDS = 8,			-- there is a 1 in this chance a random building is destroyed when looted
	
	RETINUE_FROM_REALMSIZE = 1.5,
	RETINUE_TITLE_MODIFIER = 0.5,
	RETINUE_INCREASE_PER_TECH = 0.5,
	RETINUE_HIRE_COST_MULTIPLIER = 0.2,				-- Retinues are free to hire atm, but they cost alot to reinforce
	...
	LIEGE_LEVY_COST_MULTIPLIER = 0.75,				-- The vassal will pay regular maintenance * this for the liege levy
	...
	BOTTLENECK_DEFENDER_MARTIAL_MODIFIER = 1.25,
	...
	OUTSIDE_LIEGE_LEVY_MULT = 0.4,				-- Multiplier to liege levies outside all capital regions
...
NAI =
{
	...
	PEACEAI_STALLED_WAR_WARSCORE_INCREMENT = 75,			-- Warscore reluctance decrease over time
	PEACEAI_STALLED_WAR_WARSCORE_MONTHS = 90,				-- Months until total warscore decrease takes full effect(linear)
	...
	REVOLT_OTHER_INDEP_RISK_CAP = 80,						-- Cap to the total risk from the above
	...
	RAID_AGGRESSION = 20,									-- General frequency of raids. A LOWER number means more often!
