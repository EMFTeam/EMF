...
NDiplomacy = {
	...
	INVITE_TO_COURT_INTERACTION_MONEY = 25,
...
NCharacter = {
	...
	ASSIGN_ACTION_DAYS = 14, 						-- Days before a Councillor can be assigned a new job in a county
...
NEconomy = {
	...
	BISHOP_TAX_TO_POPE_FACTOR = 0.2,				-- Bishops only pay half the tax to the Pope if they are loyal to him
...
NMilitary = {
	...
	LEVY_MAINTENANCE_FACTOR = 1.75,					-- General maintenance factor for levy troops
	...
	OPINION_WHEN_MARSHAL_INSTEAD_OF_SELF = 0,		-- Below this opinion value a vassal tends to use his marshal instead of himself when someone asks to raise his troops
	...
	OVERRUN_RATIO = 21,								-- Ratio needed for total extermination of enemy units
	...
	REBEL_LEADER_MINIMUM_LIEGE_LEVY_MULT = 1.25,-- Leader of a civil war will always get at least this multiplier of levies from fellow rebels
