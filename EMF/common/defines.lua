...
NMilitary = {
	...
	ARCHERS_PHASE_MELEE_ATTACK = 1.5,
	...
	CAPITAL_DUCHY_VASSAL_LEVY_MULT = 1.1,		-- Used instead of CAPITAL_DUCHY_LEVY_MULT for non-count vassals
...
NAI =
{
	...
	RAID_MAX_REALM_SIZE = 18,								-- Realms with more holdings than this will never go on Raids
