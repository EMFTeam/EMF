...
NDiplomacy = {
	...
	MAX_PREP_INV_TARGET_HOLDINGS = 60,			-- The target must control at the most this many holdings within the target kingdom to be a valid prepared invasion target
	MAX_PREP_INV_ATTACKER_HOLDINGS = 60,		-- The attacker must have fewer Holdings than this in the realm (disallow Prepared Invasions for rulers who are already very powerful)
...
NCharacter = {
	...
	TRIBAL_EMPTY_HOLDING_LEVY_MULTIPLIER = 0.7,
	TRIBAL_EMPTY_HOLDING_GARRISON_MULTIPLIER = 0.7,
	TRIBAL_EMPTY_HOLDING_TAX_MULTIPLIER = 0.7,
